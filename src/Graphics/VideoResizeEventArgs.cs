...
namespace Sdl.Graphics {
	...
	public class VideoResizeEventArgs : SdlEventArgs {
		...
		/// </exception>
		public static new VideoResizeEventArgs CreateEventArgs (SdlSystem.SDL_Event e) {
			return new VideoResizeEventArgs(e);
		}
	}
}
