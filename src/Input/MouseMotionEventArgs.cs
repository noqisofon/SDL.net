...
namespace Sdl.Input {
	...
	public class MouseMotionEventArgs : SdlEventArgs {
		...
		/// </exception>
		public static new MouseMotionEventArgs CreateEventArgs(SdlSystem.SDL_Event e) {
			return new MouseMotionEventArgs( e );
		}
	}
